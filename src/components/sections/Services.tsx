...
function ServiceTier({
  ...
  return (
    <motion.div
      ...
      className="group grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-16 py-10 md:py-14 border-t border-black/[0.08] dark:border-white/[0.06] hover:border-black/[0.16] dark:hover:border-white/[0.1] transition-colors duration-500 items-start cursor-default"
    >
      <div className="md:col-span-2 flex flex-col gap-3">
        ...
        <h3
          className="font-display font-semibold text-[#0A0A0A] dark:text-[#F0EDE8] transition-opacity duration-400 group-hover:opacity-80"
          style={{ fontSize: 'clamp(26px, 3vw, 44px)', letterSpacing: '-0.02em', lineHeight: 1.12 }}
        >
          {tier.name}
        </h3>
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h2
          ...
          style={{ fontSize: 'clamp(32px, 4vw, 58px)', letterSpacing: '-0.025em', lineHeight: 1.12 }}
        >
          {t.services.heading}
        </motion.h2>
        ...
        <motion.p
          ...
          className="font-sans text-[14px] leading-[1.8] text-[#7A7A7A] dark:text-[#6B6B6B] mt-14 md:mt-18 border-t border-black/[0.06] dark:border-white/[0.04] pt-10"
        >
          {t.services.pricing}
        </motion.p>
      </div>
